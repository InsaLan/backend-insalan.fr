...
class UserTestCase(TestCase):
    ...
    def test_get_existing_partner(self) -> None:
        prtn = create_partner('Partner', 'http://partner.com',
                       Partner.PartnerType.PARTNER)
...
class PartnerListViewsTest(APITestCase):
    ...
    def test_get(self) -> None:
        prtn_one = create_partner('Partner 1', 'https://partner1.com',
                                 Partner.PartnerType.PARTNER)
        prtn_two = create_partner('Partner 2', 'https://partner2.com',
...
class PartnerDetailViewTest(APITestCase):
    def test_get(self) -> None:
        prtn = create_partner('Partner 1', 'http://partner1.com',
                       Partner.PartnerType.PARTNER)
        ...
        prtn = create_partner('Partner 2', 'http://partner2.com',
                       Partner.PartnerType.SPONSOR)
        response = self.client.get(reverse('partners:detail', args=[prtn.id]))
        self.assertEqual(response.status_code, status.HTTP_200_OK)
        self.assertEqual(response.data, {
    ...
    def test_put(self) -> None:
        ...
        response = self.client.put(reverse('partners:detail', args=[prtn.id]), data={
    ...
    def test_patch(self) -> None:
        ...
        response = self.client.patch(reverse('partners:detail', args=[prtn.id]),
