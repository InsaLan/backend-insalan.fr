    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(max_length=100, validators=[django.core.validators.MinLengthValidator(8)], verbose_name="Mot de passe de l'équipe")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('payment_status', models.CharField(blank=True, choices=[('NOTPAID', 'Pas payé'), ('PAID', 'Payé'), ('LATER', 'Payera sur place')], default='NOTPAID', max_length=10, verbose_name='Statut du paiement')),
                ('pseudo', models.CharField(max_length=42, validators=[django.core.validators.MinLengthValidator(1)], verbose_name='Pseudo en jeu')),
