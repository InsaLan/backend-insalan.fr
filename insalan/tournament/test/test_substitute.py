...
class SubstituteTestCase(APITestCase):
    ...
    def test_get_user_of_substitute(self) -> None:
    ...
    def test_get_substitute_team_not_none(self) -> None:
    ...
    def test_not_substitutes(self) -> None:
    ...
    def test_one_substitute_many_teams_same_event_same_tournament_same_team(self) -> None:
    ...
    def test_one_substitute_many_teams_same_event_same_tournament_diff_team(self) -> None:
        """Test the collision of duplicate substitutes"""
        # Basic setup for a one-tournamnent game event
        event = Event.objects.create(
            name="InsaLan Test", year=2023, month=8, description=""
    ...
    def test_substitute_team_deletion(self) -> None:
    ...
    def test_patch_substitute_not_owner(self) -> None:
        """
    ...
    def test_delete_substitute(self) -> None:
        """
    ...
    def test_delete_substitute_not_owner(self) -> None:
        """
